...
//  FoodDetection
//
//  Created by Anmol's Mac on 12/6/20.
//

import UIKit
import AVFoundation

protocol FrameFetcherDelegate: class {
  func captured(image: UIImage)
}

class FrameFetcher: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
  ...
  weak var delegate: FrameFetcherDelegate?
